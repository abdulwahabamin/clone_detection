    ...
    public static void handleWeatherDataResponse(Context context, String response,String countyCode){
        ...
        try{
            ...
            try {
                ...
                e.printStackTrace();
                Log.d("DataDisposalUtil","è§£æž?aqiæ•°æ?®å¤±è´¥");
            }
            ...
            //save the data of basicInfo
                ...
                e.printStackTrace();
                Log.d("DataDisposalUtil","è§£æž?åŸºç¡€æ•°æ?®å¤±è´¥");
            }
            ...
            for(int i=0;i<7;i++) {
                ...
                e.printStackTrace();
                Log.d("DataDisposalUtil","è§£æž?7å¤©é¢„æŠ¥æ•°æ?®å¤±è´¥");
            }
            ...
            try{
                ...
                e.printStackTrace();
                Log.d("DataDisposalUtil","è§£æž?å½“å‰?å¤©æ°”æ•°æ?®å¤±è´¥");
            }
            ...
            editor.apply();}
                ...
                e.printStackTrace();
                Log.d("DataDisposalUtil","è§£æž?å»ºè®®æŒ‡æ•°æ•°æ?®å¤±è´¥");
            }
            ...
            editor.apply();}
                ...
                e.printStackTrace();
                Log.d("DataDisposalUtil","è§£æž?çŠ¶æ€?æ•°æ?®å¤±è´¥");
            }

        } catch (JSONException e){
            e.printStackTrace();
            Log.d("DataDisposalUtil","å…¨éƒ¨å¤©æ°”æ•°æ?®è§£æž?å¤±è´¥");
        }
    }
